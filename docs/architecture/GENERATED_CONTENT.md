...
Срез выполнен 2026-08-01 из установленного read-only архива:
...
- обработано 411 XML-файлов из `dlc_15_5`–`dlc_18`;
- создано 410 ключей defaults;
...
Для 13 новых машин изображения извлечены из `gfx.pak` из PCT-страниц, на которые
...
Сейчас создано 13 PNG-картинок, `copied=13`, `missing=0`. Runtime ищет картинку по
